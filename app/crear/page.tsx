    ...
    <div className="min-h-screen bg-[#080b0d] text-white">
      ...
      <main className="mx-auto max-w-5xl px-5 py-9 sm:px-8">
        <section className="text-center">
          ...
          <p className="mt-5 text-xs font-black uppercase tracking-[.2em] text-orange-400">Todo activo</p>
          <h1 className="mt-2 text-4xl font-black sm:text-5xl">Crear y ver etiquetas</h1>
          <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-slate-400">
            Tres botones. Carga la foto, CA46 lee los datos y después puedes abrir el visor de tu empresa.
          </p>
        </section>
        ...
        <section className="mt-9 grid gap-5 md:grid-cols-3">
          <Link href="/creador-etiquetas" className="rounded-[2rem] border border-orange-400/30 bg-orange-500/[.08] p-7 transition active:scale-[.99]">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-400">Haz una foto o elige varias. CA46 las lee, separa las partidas y publica etiquetas de 72 horas.</p>
          ...
          <Link href="/etiquetas" className="rounded-[2rem] border border-emerald-400/25 bg-emerald-400/[.05] p-7 transition active:scale-[.99]">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-400">Abre la pantalla de etiquetas activas de tu empresa, con carrusel y buscador táctil.</p>
        ...
        <section className="mt-6 rounded-2xl border border-white/10 bg-white/[.035] px-5 py-4 text-center text-sm font-bold text-slate-400">
          Factura = 72 h · Etiqueta física = 24 h · Todo queda separado por empresa.
        </section>
      </main>
    </div>
  );
