...
=======
    ...
    return auth;
>>>>>>> 45383443410de34fb025bbf90115a90bc782a784
}
...
export async function POST(req: Request) {
    try {
      ...
      // Retornamos 200 OK inmediatamente a Telegram para evitar el bucle de reintentos
...
--------------------------------\n\n`;
        ...
        console.error("❌ Error en el procesamiento diferido del webhook:", innerError);
        try {
